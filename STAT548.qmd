...
1.  Leiner, Duan, Wasserman, and Ramdas. [Data fission: splitting a single data point](https://arxiv.org/abs/2112.11079). *Note*: Since this paper is rather long, focus your attention on a single application. If you're not sure which to pick, then I suggest the application in Section 4. 
...
2.  Chen and Bien. [Valid inference corrected for outlier removal](https://par.nsf.gov/servlets/purl/10146539). *Note*: You do not need to fully understand Section 3.2. You can also focus your attention on the easiest case of testing an individual regression coefficient, though the paper is more general than that. 
...
3. Tan, Singh, Nasseri, Agarwal, and Yu. [Fast Interpretable Greedy-Tree Sums (FIGS)](https://arxiv.org/pdf/2201.11931.pdf) 

    **Project Idea:** In the discussion, the authors say that "the class of FIGS models could be further extended to include linear terms". Discuss the potential benefits and drawbacks of this extension. To help inform the potential benefits part of this discussion, re-visit the diabetes data set and assess the generalization performance of a linear model that includes BMI, age, and a trichotomized version of the plasma glucose variable into <= 128, 128 < PG < 166, and >= 166. 

4. **TAKEN** ~~Wang, McCormick, and Leek. [Methods for correcting inference based on outcomes predicted by machine learning](https://www.pnas.org/doi/full/10.1073/pnas.2001238117)~~
